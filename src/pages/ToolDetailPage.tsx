...
const ToolDetailPage = () => {
  ...
  // Find the tool by ID
  const tool = tools.find(t => t.id === parseInt(id || '0'));
  ...
  const toolDetails = {
    ...tool,
    longDescription: `${tool.description} This comprehensive platform offers advanced features and capabilities that make it an essential tool for professionals and businesses looking to enhance their productivity and achieve better results.`,
    features: [
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: '2024-01-10',
      comment: `${tool.name} has revolutionized my workflow. The quality and features are exceptional and it saves me hours of work every day.`,
      helpful: 24
    },
    {
      id: 2,
      ...
      rating: 5,
      date: '2024-01-08',
      comment: `As a business owner, I find ${tool.name} invaluable for our operations. Worth every penny.`,
      helpful: 18
    },
    {
      id: 3,
      ...
      rating: 4,
      date: '2024-01-05',
      comment: `Great tool with excellent features. Sometimes needs refinement, but overall very helpful for our marketing efforts.`,
      helpful: 12
    }
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-6">
          ...
          <span>/</span>
          <span>{tool.category.charAt(0).toUpperCase() + tool.category.slice(1)} Tools</span>
          <span>/</span>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <span className="bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 px-3 py-1 rounded-full text-sm font-medium">
                      {tool.category.charAt(0).toUpperCase() + tool.category.slice(1)} Tools
                    </span>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-soft p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {tool.freeTrial ? 'Free trial available' : 'Pricing varies'}
                </p>
              </div>
              ...
              <div className="text-center text-sm text-gray-500 dark:text-gray-400">
                {tool.freeTrial ? 'Free trial available' : 'Visit official website'}
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900 dark:text-white">{toolDetails.founded}</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900 dark:text-white">{toolDetails.users}</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900 dark:text-white">{toolDetails.lastUpdated}</div>
                  </div>
                </div>
              </div>
            </div>
